...
function setup(){
  ...
  ground = Bodies.rectangle(500, 1600, 1800, 60, { isStatic: true });
  ceiling = Bodies.rectangle(10000, 40050, 20000, 100, { isStatic: true });
  walls[0] = Bodies.rectangle(-500, 20000, 1000, 40000, { isStatic: true });
  walls[1] = Bodies.rectangle(0, 20000, 1000, 40000, { isStatic: true });
}
